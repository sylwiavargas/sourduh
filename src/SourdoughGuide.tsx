    ...
    steps: [
      {
        time: "6pm — done",
        icon: "✓",
        title: "Wake-up feed 1 — leave overnight",
        detail:
          "You've already done this. Leave the starter on the counter overnight with a loose lid or plate on top — not a cloth, which dries the surface out.",
      },
    ],
  },
  {
    day: "Saturday",
    label: "Wake up + mix dough",
    color: "#FAEEDA",
    border: "#854F0B",
    text: "#633806",
    steps: [
      ...
      },
      {
        ...
        title: "Bulk ferment",
        detail:
          "Leave the dough covered at room temperature until it has grown 50–75%, looks bubbly and feels jiggly. This will take roughly 3–4 hours depending on your kitchen temperature.\n\nUse the aliquot jar as a guide — when the small piece has risen by 50–75%, the dough is ready.",
      },
      {
        time: "Before bed",
        icon: "5",
        title: "Pre-shape + final shape + fridge",
        detail:
          "Pre-shape: tip dough onto an unfloured surface, fold edges in, rotate into a rough round. Rest uncovered 20 minutes.\n\nFinal shape: gently flatten, fold sides in, roll towards you to build surface tension. Place seam-side UP in a well-floured banneton or bowl.\n\nCover tightly with a plastic bag or shower cap and place in the fridge.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        time: "All weekend",
        icon: "❄",
        title: "The fridge does the work — 48 hours",
        detail:
          "Your shaped dough cold-proofs for a full 48 hours. This is the key change from your first bake — the longer cold retard is what develops the deep, complex, wheaty flavour you were after.\n\nDon't touch it. It will sit happily in the fridge until Monday evening.",
      },
    ],
  },
  {
...
const stages = [
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Starter doesn't rise after feeding",
        fix: "Kitchen too cold — move somewhere warmer (21–24°C). Or try adding a little more rye flour to the feed.",
      },
      {
        problem: "Grey liquid on top (hooch)",
        fix: "Normal — just means it's hungry. Stir it in or pour it off, then feed. Feed a little more frequently.",
      },
      {
        problem: "Hard crust on surface",
        fix: "Surface dried out. Scrape it off — the starter underneath is fine. Use a loose lid or plate next time, not a cloth.",
      },
      {
        problem: "Pink or orange streaks",
        fix: "Contamination — discard and start again. This is rare but serious.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Autolyse left too long (over 2 hours)",
        fix: "Gluten can start breaking down. Stick to 30–60 minutes.",
      },
      {
        problem: "Dough feels very stiff",
        fix: "Water was too cold. Use lukewarm water (around 25–30°C) next time.",
      },
      {
        problem: "Dry patches in the dough",
        fix: "Not mixed enough. Squeeze and fold more thoroughly until fully combined.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Forgot to add salt",
        fix: "Dissolve salt in a tiny bit of water and fold it in as soon as you notice — even mid-bulk ferment is fine.",
      },
      {
        problem: "Starter sinks in float test",
        fix: "Not ready yet. Wait another 1–2 hours and test again. Don't mix until it floats.",
      },
      {
        problem: "Dough won't come together",
        fix: "Keep squeezing and folding — it takes a few minutes. Wet hands help.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        ...
        fix: "Too tight — it needs more rest. Leave 30–45 minutes between sets.",
      },
      {
        problem: "Dough stays very slack and sticky",
        fix: "Normal at first — it firms up with each set. If still slack after 4 sets, the kitchen may be too warm or the starter too active; try a shorter bulk ferment.",
      },
      {
        problem: "Forgot to do stretch and folds",
        fix: "Your dough will be slacker and harder to shape, but it will still bake. Do 2–3 sets the next morning if you catch it in time.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Dough barely rose overnight",
        fix: "Kitchen too cold, or starter not active enough. Next time ensure starter passes float test before mixing.",
      },
      {
        problem: "Dough over-fermented (very bubbly, sticky, slack)",
        fix: "Fermented too long or kitchen too warm. Move to shaping immediately even if timing is off. Reduce bulk time next bake.",
      },
      {
        problem: "Hard to tell if it's ready",
        fix: "Use the aliquot method — a small piece in a glass of water shows clearly how much the dough has risen.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Dough sticks to everything",
        fix: "Use wet hands, not flour. A bench scraper is essential for sticky dough. Don't over-handle it.",
      },
      {
        problem: "Dough tears during shaping",
        fix: "Too tight from over-development or cold. Let it rest longer during bench rest.",
      },
      {
        problem: "Can't build any tension — loaf spreads flat",
        fix: "Under-developed gluten from skipped stretch and folds. Chill the dough in the fridge for 20 minutes first — cold dough is easier to shape.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Dough over-proofs in the fridge",
        fix: "Usually only happens after 48+ hours. Check at 36 hours — if it's very bubbly and puffy, bake sooner.",
      },
      {
        problem: "Dough forms a dry skin in the fridge",
        fix: "Not covered tightly enough. Use cling film or a shower cap — no gaps.",
      },
      {
        problem: "Loaf doesn't spring in the oven",
        fix: "May have over-proofed or the starter wasn't active enough. The cold retard itself is not usually the cause.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        problem: "Score doesn't open up (no ear)",
        fix: "Blade not sharp enough, or angle too steep. Score at 30–45° to the surface, not straight down. Cold dough scores better.",
      },
      {
        problem: "Dough deflates when scored",
        fix: "Over-proofed — the gluten structure is too weak to hold the gas. Score quickly and get it straight in the oven.",
      },
      {
        problem: "Score sticks or drags",
        fix: "Use a razor blade or lame, not a kitchen knife. Wet the blade slightly.",
      },
    ],
  },
  {
    ...
    whatCanGoWrong: [
      {
        ...
        fix: "Oven not hot enough, or steam phase too short, or lid removed too early. Preheat longer and make sure the vessel is truly hot.",
      },
      {
        problem: "Top scorches before loaf is baked through",
        fix: "Move shelf one position lower first. If still scorching, reduce to 220°C after the first 10 minutes.",
      },
      {
        problem: "Gummy, dense crumb",
        fix: "Cut too soon — the loaf is still cooking inside when it comes out. Wait at least 1 hour, ideally 2, before slicing.",
      },
      {
        problem: "Flat loaf with no oven spring",
        fix: "Either the starter was weak, dough over-proofed, or not enough steam. Check all three on your next bake.",
      },
    ],
  },
];
    ...
    >
        ...
        {TABS.map((t) => (
          <button
            ...
            style={{
              ...
              background:
                tab === t ? "var(--color-background-secondary)" : "transparent",
              color: "var(--color-text-primary)",
              cursor: "pointer",
      ...
      {tab === "schedule" && (
        <div>
          ...
          >
            Feed your starter today (Saturday), bake next Friday. Click any day
            to expand.
          </p>
          {days.map((d, i) => (
            <div key={i} style={{ marginBottom: 10 }}>
              ...
              >
                <span style={{ fontWeight: 500, fontSize: 15, color: d.text }}>
                  {d.day}
                </span>
                <span
                  style={{
                  ...
                  {d.steps.map((s, j) => {
                    ...
                    return (
                      <div
                        key={j}
                        style={{
                          marginBottom: j < d.steps.length - 1 ? 12 : 0,
                        }}
                      >
                        <button
                          onClick={() =>
          ...
          >
            ...
            London kitchens often run 18–22°C. If yours is cooler, fermentation
            will be slower — add 1–2 hours to bulk ferment. Always go by the
            look and feel of the dough, not the clock alone.
          </div>
        </div>
      )}
      ...
      {tab === "flour" && (
        <div>
          ...
          >
            In the UK, flour is named differently from the US. Here's what to
            buy and where to find it in London.
          </p>
          {[
            {
              ...
              brands: [
                ...
                "Marriages Strong White",
                "Doves Farm Strong White",
                "Waitrose Duchy Organic Strong White",
              ],
              where:
                "Any major supermarket (Sainsbury's, Tesco, Waitrose, Ocado, M&S)",
              notes:
                "The easiest flour to work with. High protein gives strong gluten, great rise, and an open crumb. Start here. Never use plain flour — it's too low in protein.",
            },
            {
              name: "Premium artisan strong white",
              protein: "12.5–13.5%",
              recommended: false,
              badge: "Step up",
              brands: [
                ...
                "Shipton Mill No.4",
                "Gilchesters Organic Strong White",
              ],
              where: "Bakery Bits, Shipton Mill online, independent delis",
              notes:
                "British heritage wheat, more complex flavour. Excellent but not essential to start.",
            },
            {
              name: "Wholemeal rye flour",
              protein: "8–10%",
              recommended: false,
              badge: "For starter only",
              brands: [
                "Doves Farm Organic Wholemeal Rye (Amazon UK)",
                "Shipton Mill Rye",
                "Matthews Cotswold Rye",
              ],
              where: "Most supermarkets and Amazon UK",
              notes:
                "Use 20% in every starter feed (alongside 80% strong white). Rich in wild yeasts and enzymes — gives your starter a big activity boost. Don't use white rye — the bran has been removed, which removes the benefit.",
            },
            {
              name: "Wholemeal strong flour",
              protein: "11–13%",
              recommended: false,
              badge: "Add 20% to bread",
              brands: [
                "Allinson Wholemeal",
                "Matthews Cotswold Stoneground Wholemeal",
                "Doves Farm Wholemeal",
              ],
              where: "Supermarkets and online",
              notes:
                "Use as 20–30% of the total bread flour alongside strong white for a nuttier flavour. Don't use 100% — it makes a dense loaf.",
            },
          ].map((f, i) => (
            <div
              key={i}
      ...
      {tab === "stages" && (
        <div>
          ...
          >
            What each stage does, why it matters, and what can go wrong. Click a
            stage to expand.
          </p>
          {stages.map((s, i) => (
            <div key={i} style={{ marginBottom: 10 }}>
                  ...
                  {s.whatCanGoWrong.map((p, j) => {
                    ...
                    return (
                      <div key={j} style={{ marginBottom: 6 }}>
                        <button
                          onClick={() =>
                            setOpenProblem(openProblem === pk ? null : pk)
                          }
                          style={{
                            width: "100%",
                            textAlign: "left",
      ...
      {tab === "recipes" && (
        <div>
          ...
          >
            Three beginner-friendly recipes — no Dutch oven needed for any of
            them. Click a recipe to expand.
          </p>
          {recipes.map((r, i) => (
            <div key={i} style={{ marginBottom: 12 }}>
              ...
              >
                <div>
                  <div style={{ fontWeight: 500, fontSize: 15, color: r.text }}>
                    {r.name}
                  </div>
                  <div style={{ fontSize: 12, color: r.border, marginTop: 2 }}>
                    {r.level} · {r.time}
                  </div>
                </div>
                <span style={{ fontSize: 12, color: r.border }}>
                  {openRecipe === i ? "▲" : "▼"}
                </span>
              </button>
              {openRecipe === i && (
